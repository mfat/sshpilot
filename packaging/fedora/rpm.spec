...
- Fixed the scroll wheel not working while terminal shortcut pass-through is on
- Fixed a local terminal tab staying open with an SSH error after pressing Ctrl+C and typing exit

* Mon Sep 21 2026 mFat <newmfat@gmail.com> - 6.1.9-1
- New port-knocking/pre-connect command configuration dialog
...
* Tue Sep 15 2026 mFat <newmfat@gmail.com> - 6.1.3-1
- Bug fixes

* Mon Sep 14 2026 mFat <newmfat@gmail.com> - 6.1.2-1
- Added support for importing authorized keys from GitHub, GitLab, Launchpad or a URL
- Fixed overlapping scrollbars in splitview
...
* Sat Sep 05 2026 mFat <newmfat@gmail.com> - 6.0.4-1
- Bug fixes

* Wed Sep 02 2026 mFat <newmfat@gmail.com> - 6.0.3-1
- Bug fixes

* Mon Aug 31 2026 mFat <newmfat@gmail.com> - 6.0.2-1
- Improvements to isolated workspace mode
- Middle-click a group to open all connections in splitview

* Mon Aug 31 2026 mFat <newmfat@gmail.com> - 6.0.1-1
- Improvements to isolated workspace mode
- Middle-click a group to open all connections in splitview
...
* Mon Aug 24 2026 mFat <newmfat@gmail.com> - 5.9.3-1
- Bug fixes and UI improvements

* Sat Aug 22 2026 mFat <newmfat@gmail.com> - 5.9.2-1
- Fixes drag and drop reordering not working
- Adds manual sorting option

* Sat Aug 22 2026 mFat <newmfat@gmail.com> - 5.9.1-1
- Added French translation
- Minor UI improvements

* Fri Aug 21 2026 mFat <newmfat@gmail.com> - 5.9.0-1
- Integrated tab bar into header for a cleaner, more minimal user interface
- Revamped Command Snippets panel - the snippets are now displayed in a floating panel
- Added keyboard support to Snippets - you can assign your desired shortcut for the popup
- Added theme selector to main menu, inspired by Ptyxis
- Minor UI improvements

* Fri Aug 21 2026 mFat <newmfat@gmail.com> - 5.8.9-1
- Bug fixes and improvements

* Thu Aug 20 2026 mFat <newmfat@gmail.com> - 5.8.8-1
- Improved full-screen experience (activated with F11 on linux, Cmd+Ctrl+F on macOS)
- Improved app menu on macOS
- Added animated effect to omnisearch
- Added workaround for French keyboard layout on macOS
- Bug fixes and improvements

* Tue Aug 18 2026 mFat <newmfat@gmail.com> - 5.8.7-1
- Bug fixes

* Mon Aug 17 2026 mFat <newmfat@gmail.com> - 5.8.6-1
- Bug fixes and improvements

* Mon Aug 17 2026 mFat <newmfat@gmail.com> - 5.8.5-1
- Improved effective config diff tool
- Improved experience when switching operation mode
- Bug fixes

* Mon Aug 17 2026 mFat <newmfat@gmail.com> - 5.8.4-1
- Bug fixes and improvements

* Sun Aug 16 2026 mFat <newmfat@gmail.com> - 5.8.3-1
- Bug fixes and improvements

* Sun Aug 16 2026 mFat <newmfat@gmail.com> - 5.8.2-1
- Bug fixes and improvements
...
* Wed Jul 22 2026 mFat <newmfat@gmail.com> - 5.6.6-1
- Enhanced CLI interface - start sshpilot from commandline like "sshpilot user@host", use --sftp to open the file manager
- Bug fixes and UI improvements

* Tue Jul 21 2026 mFat <newmfat@gmail.com> - 5.6.5-1
- Bug fixes and UI improvements

* Tue Jul 21 2026 mFat <newmfat@gmail.com> - 5.6.4-1
- Bug fixes

* Tue Jul 21 2026 mFat <newmfat@gmail.com> - 5.6.3-1
- Bug fixes

* Tue Jul 21 2026 mFat <newmfat@gmail.com> - 5.6.2-1
- Bug fixes

* Tue Jul 21 2026 mFat <newmfat@gmail.com> - 5.6.1-1
- Bug fixes
