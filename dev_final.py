#!/usr/bin/env python3
"""
Final development runner for sshPilot with hot reloading
Clean, stable version with proper error handling
"""
...
class DevFileHandler(FileSystemEventHandler):
    """File system event handler for development"""
    
    def __init__(self, restart_callback):
        self.restart_callback = restart_callback
        self.last_restart = 0
        self.restart_delay = 2.0  # 2 second delay between restarts
...
class DevRunner:
    """Development runner with hot reloading"""
    ...
    def start_watching(self):
        ...
        handler = DevFileHandler(self.restart_application)
