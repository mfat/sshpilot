...
graph TD
    ...
    subgraph Runtime
        ...
        actionHandlers[
            ...
            on_tab_overview/on_broadcast_command/
            on_edit_ssh_config
        ]
    end
...
7. Action callbacks dispatch to the active window for UI operations (opening connections, toggling lists/tabs, managing files, terminals, help/about dialogs, broadcast commands, etc.).【F:sshpilot/main.py†L497-L676】
