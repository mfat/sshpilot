...
RELATED_METHODS = {
    ...
    "EffectiveConfigComparison": ("get_effective_config",),
    "UnsavedHostCheckRequest": ("check_unsaved_host",),
    "UnsavedHostCheckResult": ("check_unsaved_host",),
    "SetOperationModeRequest": ("set_operation_mode",),
    "OperationModeResult": ("set_operation_mode", "get_operation_mode"),
    "CreateConnectionRequest": ("create_connection",),
    "AsbruImportRequest": ("import_asbru",),
    "AsbruImportPreview": ("preview_asbru_import",),
    "AsbruImportResult": ("import_asbru",),
    "AsbruImportMode": ("import_asbru",),
    ...
    "ExternalTerminalLaunchSpec": ("prepare_external_terminal_launch",),
    "SessionSummary": (
        "list_sessions",
        "get_session",
        "open_session",
