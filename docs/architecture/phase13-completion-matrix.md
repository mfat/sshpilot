...
| Phase 13.3 daemon lifecycle proof + shutdown | `tests/manual/phase13_production_smoke.py` (steps 41-52) + `tests/daemon/test_lifecycle_phase13_3.py` | Ephemeral daemon + public API shutdown + idle/force tests | 52-step smoke + 14 lifecycle tests | `phase13-3-daemon-shutdown-proof.md` | **Complete** |
