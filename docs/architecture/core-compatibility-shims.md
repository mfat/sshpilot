...
| `sshpilot.connection_manager.ConnectionManager` | `core.connections.ConnectionService` | GObject compatibility adapter; daemon route owns persistence |
