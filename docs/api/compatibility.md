...
0.53 extended the host-information snapshot, 0.52 introduced Host Info, 0.51
introduced strict builtin-plugin session failures, 0.50 introduced strict
`ScpFailure` and `IdentityFailure`, and 0.49 introduced strict `SftpFailure`.
